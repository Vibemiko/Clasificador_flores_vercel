        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="text-center space-y-3">
            ...
            >
              ...
              <h3 className="text-base font-semibold text-slate-800">Acerca del Proyecto</h3>
            </motion.div>
            
            <div className="bg-slate-50 rounded-lg p-4 max-w-4xl mx-auto">
              <div className="grid md:grid-cols-2 gap-4 text-left">
                <div className="space-y-2">
                  <h4 className="font-medium text-slate-800 text-xs uppercase tracking-wide">Información Académica</h4>
                ...
                <div className="space-y-2">
                  <h4 className="font-medium text-slate-800 text-xs uppercase tracking-wide">Integrantes del Equipo</h4>
